  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title
       ...
       subTitle='Tracl all customer bookings, pprove or cancel requests and manage booking status.'
       />
        ...
        <table className='w-full borer-collapse text-left text-sm text-gray-600'>
          <thead className='text-gray-500'>
            <tr>
              ...
              <th className='p-3 font-medium'>Total ({currency})</th>
            ...
            {bookings.map((booking, index) => (
              <tr key={index} className='border-t border-borderColor text-gray-500'>
                <td className='p-3 flex items-center gap-3'>
                  ...
                  <p className='font-medium max-md:hidden'>{booking.car.brand} {booking.car.brand}</p>
                </td>
                <td className='p-3 max-md:hidden'>
                  {booking.pickupDate.split('T')[0]} to {booking.dropDate.split('T')[0]}
                </td>

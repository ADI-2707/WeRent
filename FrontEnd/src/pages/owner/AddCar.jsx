    ...
    <div className="px-4 py-10 md:px-10 flex-1">
      ...
      >
        <div className="flex items-center gap-2 w-full">
          ...
          <p className="text-sm text-gray-500">Upload a image of your car</p>
        </div>
        ...
        <button className="flex itms-center gap-2 px-4 py-2.5 mt-4 bg-primary text-white rounded-md font-medium w-max cursor-pointer">
